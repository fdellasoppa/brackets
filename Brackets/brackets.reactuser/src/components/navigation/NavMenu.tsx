...
function NavMenu() {
    ...
    return (
        <>
        <div className="top-row ps-3 navbar bg-black">
            <div className="container-fluid">
                <a className="navbar-brand" href=""><img className="baufest-worldcup" src="/images/banners/baufest-worldcup.png" /></a>
        ...
        <div className="">
            <nav className="flex-column">
                ...
                <div className="nav-bottom">
                    <div className="nav-item">
                        <a className="nav-link" href="culture-example">
